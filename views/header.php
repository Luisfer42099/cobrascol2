...
<head>
            ...
            if (!myLandbot) {
                ...
                s.addEventListener('load', function() {
                    var myLandbot = new Landbot.Livechat({
                        configUrl: 'https://storage.googleapis.com/landbot.online/v3/H-1378466-9ND8LGC56T76UO5U/index.json',
                    });
                });
    ...
    <script async src="https://www.googletagmanager.com/gtag/js?id=UA-242288083-1"></script>
    <script>
    ...
    <script>
        ...
        fbq('init', '964631661605645');
        fbq('track', 'PageView');
    </script>
    <noscript> <img height="1" width="1" src="https://www.facebook.com/tr?id=964631661605645&ev=PageView&noscript=1" /></noscript>
